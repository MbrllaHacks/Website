  ...
  return ( <Navbar collapseOnSelect expand="lg">
            ...
            <Navbar.Collapse id="responsive-navbar-nav">
              ...
              <Nav className='navele'>
                ...
                <Nav.Link href="#@" className='nel spc'><img src={a} width="30px" ></img></Nav.Link>
                <Nav.Link href="#Discord" className='nel'><img src={disc} width="30px"></img></Nav.Link>   {/* Add Discord Link here */}
                <Nav.Link href="#Twitter" className='nel'><img src={twitter} width="30px"></img></Nav.Link> {/* Add Twitter Link here */}
                <Nav.Link href="#Instagram" className='nel'><img src={insta} width="30px"></img></Nav.Link> {/* Add Insta link here   */}
              </Nav>
            </Navbar.Collapse>
            </Container>
          </Navbar>
